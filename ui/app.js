...
const TRANSLATIONS = {
  ...
  zh: {
    ...
    "partner.market": "市场", "partner.followers": "受众规模", "partner.channel": "渠道", "partner.type": "合作类型", "partner.activity": "活跃度", "partner.relevance": "相关度", "partner.audience": "可能受众", "partner.viewEvidence": "查看证据", "partner.review": "审核", "partner.openProfile": "打开主页", "partner.audienceUnknown": "受众不明确", "partner.contactAvailable": "可联系",
...
function renderPartnerDetail(detail) {
  ...
  $('#detail-content').innerHTML = `<div class="partner-evidence">
    ...
    <section class="observed-content">
      ...
      <a class="button mini" href="${escapeHtml(raw.profile_url)}" target="_blank" rel="noreferrer">${t("partner.openProfile")} ↗</a>
    </section>
